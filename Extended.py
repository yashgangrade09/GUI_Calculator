...
class calculator:
    ...
    def __init__(self, application):
        ...
        equalsButton = Button(application,text="=",width=11,height=3,fg="white", bg="blue",command=lambda:self.equals())
        equalsButton.grid(row=4, column=4,columnspan=4)
        ...
        moduloButton = Button(application,text="%",width=5,height=3, fg="blue",bg="orange", command=lambda:self.action('%')).grid(row=4, column=2) 
  
        decimalButton = Button(application,text=".",width=5,height=3, fg="blue",bg="orange", command=lambda:self.action('.')).grid(row=4, column=1) 

        openParaButton = Button(application,text="(",width=5,height=3, fg="blue",bg="orange", command=lambda:self.action('(')).grid(row=2, column=4) 
        ...
        squareRootButton = Button(application,text="sqrt",width=5,height=3, fg="blue",bg="orange", command=lambda:self.squareroot()).grid(row=3, column=4) 
